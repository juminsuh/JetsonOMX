...
class Kinematic:
    ...
    def __init__(self, phi_resolution: float = 1.0):
        ...
        self.a1 = 11.3  # Shoulder to elbow length
        self.a2 = 16.2  # Elbow to wrist length  
        self.a3 = 12  # Wrist to end effector length
        ...
        self.joint_limits = {
            0: (-270, 360),    # Base rotation
            1: (-120, 90),    # Shoulder pitch
            2: (-120, 90),    # Elbow pitch
            3: (-100, 100),    # Wrist pitch
            4: (-270, 270),    # Wrist roll
            5: (0, 100),    # Gripper
        }
